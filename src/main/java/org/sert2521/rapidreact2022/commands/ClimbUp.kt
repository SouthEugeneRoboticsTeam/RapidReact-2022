...
class ClimbUp : SequentialCommandGroup() {
    init {
        addCommands(
            ...
            SetClimberPID(MID_HEIGHT, MID_HEIGHT, HIT_MID_ANGLE) { Input.getClimbNext() },
            SetClimberLinear(HIT_MID_HEIGHT, HIT_MID_HEIGHT, HIT_MID_ANGLE, staticSpeed = LOW_SPEED, variableSpeed = LOW_SPEED) { Input.getClimbNext() },
