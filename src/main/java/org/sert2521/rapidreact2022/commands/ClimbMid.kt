...
class ClimbMid : SequentialCommandGroup() {
    init {
        addCommands(
            ...
            SetClimberPID(HIT_MID_HEIGHT, HIT_MID_HEIGHT, HIT_MID_ANGLE) { OI.getClimbNext() },
            ...
            SetClimberPID(HANG_HEIGHT, HIT_HIGH_HEIGHT, HIT_HIGH_ANGLE),
            ...
            SetClimberLinear(LET_GO_MID_HEIGHT, HIT_HIGH_HEIGHT, HIT_HIGH_ANGLE, staticSpeed = RELEASE_SPEED),
        )
    }
}
